...
docker-compose -f deployment/docker-compose.local-network.yml up -d
...
docker-compose -f deployment/docker-compose.local-network.yml ps
...
echo.
echo 🔧 To stop services: docker-compose -f deployment/docker-compose.local-network.yml down
echo 📊 To view logs: docker-compose -f deployment/docker-compose.local-network.yml logs -f
echo.
pause
